(function() { "use strict";
	...
	if ((/iphone|ipad|android/i).test(navigator.userAgent) && window.DeviceOrientationEvent) {
	...
	function resize() {
		...
		body.style.fontSize = Math.max(42, Math.round(Math.min(areawidth/13, areaheight/13))) +'px';
		// body.style.boxShadow = 'inset 0 0 '+ areawidth/4.5 +'px #404042, inset 0 0 '+ areawidth/4.5 +'px #404042';
